...
exports.mkdir = function(options,callback){
    var conn = new FTPClient();
    conn.on('ready',function(){
        process.stdout.write("mkdir " + options.dir + " ");
        conn.mkdir(options.dir, function(e){
            if(e){
                process.stdout.write(e.toString().red+"\r\n");
            }else{
                process.stdout.write("done".green+"\r\n");
...
exports.downloadFile = function(options,callback){
    var conn = new FTPClient();
    conn.on('ready', function(){
        process.stdout.write("download "+options.remoteName+" ");
