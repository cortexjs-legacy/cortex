...
function check_duplicate_version(modules, cwd, tools){
    var map = {};
    ...
    modules.forEach(function(module) {
        ...
        if(pkg_name === name){
            tools.error('You should not install a module "' + name + '" into itself.');
    ...
    save: {
        ...
        value: function(save, parsed, tools) {
            ...
            if(save){
                ...
                var cwd = parsed.cwd = pkg_helper.repo_root(parsed.cwd);
                if(cwd === null){
    ...
    modules: {
        ...
        value: function(modules, parsed, tools) {
            ...
            parsed.save ? 
                ...
                // prohibited: a a 
                // allow: a@0.0.1 b
                check_duplicate_version(parsed_modules, parsed.cwd, tools) :
