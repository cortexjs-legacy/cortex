...
exports._get_modules = function (options, callback) {
    ...
    exports._get_pkg(cwd, function (err, pkg) {
        ...
        var deps_map = exports._get_all_deps(pkg);
...
exports._get_all_deps = function (pkg) {
    var deps_obj = {};

    // When user executes `cortex install`, always install all dependencies.
    // But cortex will not install 
    // 'asyncDependencies' and 'devDependencies' recursively which handled by neuropil.
    ['dependencies', 'asyncDependencies', 'devDependencies'].forEach(function (key) {
