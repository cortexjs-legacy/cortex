...
exports._get_modules = function(options, callback) {
  ...
  exports._get_pkg(cwd, function(err, pkg) {
    ...
    fs.exists(shrinkwrap_json, function (exists) {
      if (exists) {
        return exports._modules_from_shrinkwrap_json(shrinkwrap_json, pkg, options, callback);
      }

      exports._modules_from_cortex_json(pkg, options, callback);
    });
  });
};


var PRODUCTION_DEP_KEYS = ['dependencies', 'asyncDependencies'];
var NON_PRODUCTION_DEP_KEYS = ['dependencies', 'asyncDependencies', 'devDependencies'];

exports._modules_from_shrinkwrap_json = function (file, pkg, options, callback) {
  shrinked(file, {
    ...
    var modules = Object.keys(tree).reduce(function (prev, name) {
...
exports._modules_from_cortex_json = function (pkg, options, callback) {
