...
install.build_packages = function(options, callback) {
  ...
  var dest = options.cwd
    // if install inside a repo, install into neuron dir
    ? node_path.join(options.cwd, 'neurons')
    // else, build to built_root
