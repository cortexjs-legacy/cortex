...
install.build_package = function(options, callback) {
  ...
  this.iterate_packages(options.data, function(name, version) {
    tasks.push(function(done) {
      var cwd = node_path.join(options.module_root, name, version, 'package');
      ...
      if (options.cwd) {
        // if `options.cwd` is not specified modules will be installed globally
...
install.clone_to_workspace = function(options, callback) {
  ...
  async.each(modules, clone_module, callback);
};
